let allCases = [];
let filteredCases = [];
const tableName = 'khcn_matter_standard';
let currentPage = 1;
...
function addNewCase() {
    ...
    const modalContent = `
        <div class="modal-header">
            <h5 class="modal-title">Thêm mới sự vụ đo lường chất lượng</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
        </div>
        <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="type" required>
                            ...
                            <option value="regulation">Quy chuẩn</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="department" required>
                            ...
                            <option value="Phòng Quản lý CL">Phòng Quản lý CL</option>
...
async function saveNewCase() {
    try {
        ...
        const formData = {
            ...
            case_type: form.querySelector('[name="type"]').value, // Use case_type
            discovery_date: form.querySelector('[name="discoverydate"]').value, // Use discovery_date
            ...
            <form id="editCaseForm" class="needs-validation" novalidate>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label class="form-label required">Loại sự vụ</label>
                        <select class="form-select" name="type" required>
                            <option value="standard" ${caseData.case_type === 'standard' ? 'selected' : ''}>Tiêu chuẩn</option>
                            <option value="regulation" ${caseData.case_type === 'regulation' ? 'selected' : ''}>Quy chuẩn</option>
                            <option value="inspection" ${caseData.case_type === 'inspection' ? 'selected' : ''}>Kiểm định</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label class="form-label required">Đơn vị xử lý</label>
                        <select class="form-select" name="department" required>
                            <option value="Phòng Quản lý CL" ${caseData.department === 'Phòng Quản lý CL' ? 'selected' : ''}>Phòng Quản lý CL</option>
...
function generateNextId() {
    ...
    return `DL${String(nextNumericPart).padStart(3, '0')}`;
}