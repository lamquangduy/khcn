let allCases = [];
let filteredCases = [];
const tableName = 'khcn_matter_tech';
let currentPage = 1;
...
async function loadCases() {
    try {
        ...
        alert('Không thể tải dữ liệu sự vụ công nghệ. Vui lòng thử lại sau.');
    } finally {
        hideLoading();
    }
}
...
function addNewCase() {
   ...
   const modalContent = `
         <div class="modal-header">
            <h5 class="modal-title">Thêm mới sự vụ công nghệ</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
        </div>
        <div class="modal-body">
                    ...
                    <div class="col-md-6">
                       <label class="form-label required">Loại sự vụ</label>
                        <select class="form-select" name="type" required>
                            ...
                            <option value="new">Công nghệ mới</option>
                            <option value="product">Sản phẩm công nghệ</option>
                             <option value="innovation">Dự án đổi mới</option>
                       ...
                       <label class="form-label required">Đơn vị xử lý</label>
                         <select class="form-select" name="department" required>
                            <option value="">Chọn đơn vị xử lý</option>
                             <option value="Phòng Quản lý CN">Phòng Quản lý CN</option>
        ...
        if (!form.checkValidity()) {
         ...
         const formData = {
           ...
           title: form.querySelector('[name="title"]').value,
            ...
            discoverydate: form.querySelector('[name="discoveryDate"]').value, // Corrected property name here
            ...
            <form id="editCaseForm" class="needs-validation" novalidate>
               ...
               <div class="row mb-3">
                    <div class="col-md-6">
                       <label class="form-label required">Loại sự vụ</label>
                        <select class="form-select" name="type" required>
                           <option value="new" ${caseData.type === 'new' ? 'selected' : ''}>Công nghệ mới</option>
                            <option value="product" ${caseData.type === 'product' ? 'selected' : ''}>Sản phẩm công nghệ</option>
                            <option value="innovation" ${caseData.type === 'innovation' ? 'selected' : ''}>Dự án đổi mới</option>
                ...
                <!-- Thông tin thời gian và mức độ -->
                 <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" name="discoveryDate"
                               value="${caseData.discoverydate}" required // Corrected property name here
                 ...
                 <div class="row mb-3">
                    <div class="col-md-6">
                         <label class="form-label required">Đơn vị xử lý</label>
                         <select class="form-select" name="department" required>
                            <option value="Phòng Quản lý CN" ${caseData.department === 'Phòng Quản lý CN' ? 'selected' : ''}>Phòng Quản lý CN</option>
